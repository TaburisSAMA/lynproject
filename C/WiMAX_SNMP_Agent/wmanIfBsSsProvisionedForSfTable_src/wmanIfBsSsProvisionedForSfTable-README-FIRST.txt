...
begin with the wmanIfBsSsProvisionedForSfTable prefix.
...
------------------------------------------------------------------------
  ...
  File    : wmanIfBsSsProvisionedForSfTable_Makefile
  ----------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f wmanIfBsSsProvisionedForSfTable_Makefile


  File    : wmanIfBsSsProvisionedForSfTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   wmanIfBsSsProvisionedForSfTable-README-wmanIfBsSsProvisionedForSfTable.txt
...
------------------------------------------------------------------------
  ...
  File    : wmanIfBsSsProvisionedForSfTable_interface.c
