************************************************************************
wmanIfBsSsProvisionedForSfTable README
------------------------------------------------------------------------
  ...
  the wmanIfBsSsProvisionedForSfTable table.  The agent will start by looking for the right
  ...
  file defaults/table-wmanIfBsSsProvisionedForSfTable.m2d, and then re-running mib2c.
    ...
    in the wmanIfBsSsProvisionedForSfTable.h header.
 ...
 Index(es) for the wmanIfBsSsProvisionedForSfTable table
  ------------------------------------------------------------
  The index(es) for the wmanIfBsSsProvisionedForSfTable table are:
...
************************************************************************
wmanIfBsSsProvisionedForSfTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the wmanIfBsSsProvisionedForSfTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: wmanIfBsSsProvisionedForSfTable_data_access.[c|h]
------------------------------------------------------------------------
  The wmanIfBsSsProvisionedForSfTable_data_access file contains the interface to your data in
  ...
  FUNC : wmanIfBsSsProvisionedForSfTable_indexes_set
  WHERE: wmanIfBsSsProvisionedForSfTable_data_access.c
...
File: wmanIfBsSsProvisionedForSfTable_enums.h
------------------------------------------------------------------------
...
File: wmanIfBsSsProvisionedForSfTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : wmanIfBsSsProvisionedForSfRowStatus_get



File: wmanIfBsSsProvisionedForSfTable_data_set.c
------------------------------------------------------------------------
  ...
  Set $m2c_table_dependencies = 0 in defaults/table-wmanIfBsSsProvisionedForSfTable.m2d
  ...
  FUNC : wmanIfBsSsProvMacAddress_check_index

  Validate index component
  ------------------------
  TODO : validate the specified index component
  FUNC : wmanIfBsProvSfId_check_index


  Validate index
  --------------
  TODO : check that all index components are valid
  FUNC : wmanIfBsSsProvisionedForSfTable_validate_index
  ...
  FUNC : wmanIfBsSsProvisionedForSfTable_undo_setup
  ...
  FUNC : wmanIfBsSsProvisionedForSfRowStatus_check_value
  ...
  FUNC : wmanIfBsSsProvisionedForSfRowStatus_undo_setup
  ...
  FUNC : wmanIfBsSsProvisionedForSfRowStatus_set
  ...
  FUNC : wmanIfBsSsProvisionedForSfRowStatus_undo
  ...
  --------------
  TODO : commit changes
  FUNC : wmanIfBsSsProvisionedForSfTable_commit
...
************************************************************************
wmanIfBsSsProvisionedForSfTable Reference
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      were generated for the wmanIfBsSsProvisionedForSfTable table.

To watch the flow of the wmanIfBsSsProvisionedForSfTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        wmanIfBsSsProvisionedForSfTable
        verbose:wmanIfBsSsProvisionedForSfTable
        internal:wmanIfBsSsProvisionedForSfTable

e.g.
        snmpd -f -Le -DwmanIfBsSsProvisionedForSfTable,verbose:wmanIfBsSsProvisionedForSfTable,internal:wmanIfBsSsProvisionedForSfTable
