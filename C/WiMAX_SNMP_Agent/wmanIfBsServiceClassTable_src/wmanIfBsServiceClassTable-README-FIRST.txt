...
begin with the wmanIfBsServiceClassTable prefix.
...
------------------------------------------------------------------------
  ...
  File    : wmanIfBsServiceClassTable_Makefile
  ----------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f wmanIfBsServiceClassTable_Makefile


  File    : wmanIfBsServiceClassTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   wmanIfBsServiceClassTable-README-wmanIfBsServiceClassTable.txt
...
------------------------------------------------------------------------
  ...
  File    : wmanIfBsServiceClassTable_interface.c
