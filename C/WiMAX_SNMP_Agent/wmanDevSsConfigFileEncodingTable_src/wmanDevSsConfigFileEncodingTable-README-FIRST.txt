...
begin with the wmanDevSsConfigFileEncodingTable prefix.
...
------------------------------------------------------------------------
  ...
  File    : wmanDevSsConfigFileEncodingTable_Makefile
  ----------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f wmanDevSsConfigFileEncodingTable_Makefile


  File    : wmanDevSsConfigFileEncodingTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   wmanDevSsConfigFileEncodingTable-README-wmanDevSsConfigFileEncodingTable.txt
...
------------------------------------------------------------------------
  ...
  File    : wmanDevSsConfigFileEncodingTable_interface.c
