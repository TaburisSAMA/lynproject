...
begin with the wmanIfBsRegisteredSsTable prefix.
...
------------------------------------------------------------------------
  ...
  File    : wmanIfBsRegisteredSsTable_Makefile
  ----------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f wmanIfBsRegisteredSsTable_Makefile


  File    : wmanIfBsRegisteredSsTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   wmanIfBsRegisteredSsTable-README-wmanIfBsRegisteredSsTable.txt
...
------------------------------------------------------------------------
  ...
  File    : wmanIfBsRegisteredSsTable_interface.c
