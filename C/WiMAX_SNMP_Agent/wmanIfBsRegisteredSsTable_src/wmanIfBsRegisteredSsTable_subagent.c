...
{
    printf
        ("usage: wmanIfBsRegisteredSsTable [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING ADDRESSES]\n"
...
main(int argc, char **argv)
{
    ...
    while ((ch = getopt(argc, argv, "D:fHLMx:")) != EOF)
        ...
        case 'H':
            ...
            init_agent("wmanIfBsRegisteredSsTable");    /* register our .conf handlers */
     ...
     */
    init_agent("wmanIfBsRegisteredSsTable");

    /*
     * init wmanIfBsRegisteredSsTable mib code 
     */
    init_wmanIfBsRegisteredSsTable();

    /*
     * read wmanIfBsRegisteredSsTable.conf files. 
     */
    init_snmp("wmanIfBsRegisteredSsTable");
     ...
     * at shutdown time 
     */
    snmp_shutdown("wmanIfBsRegisteredSsTable");
    SOCK_CLEANUP;
    exit(0);
}
