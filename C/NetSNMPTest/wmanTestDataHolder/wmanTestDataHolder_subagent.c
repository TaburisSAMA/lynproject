...
{
    printf
        ("usage: wmanTestDataHolder [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING ADDRESSES]\n"
...
main(int argc, char **argv)
{
    ...
    while ((ch = getopt(argc, argv, "D:fHLMx:")) != EOF)
        ...
        case 'H':
            ...
            init_agent("wmanTestDataHolder");   /* register our .conf handlers */
    ...
    /*
     * init wmanTestDataHolder mib code 
     */
    init_wmanTestDataHolder();

    /*
     * read wmanTestDataHolder.conf files. 
     */
    init_snmp("wmanTestDataHolder");
