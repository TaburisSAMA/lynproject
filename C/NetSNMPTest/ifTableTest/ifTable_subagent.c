...
{
    printf
        ("usage: ifTable [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING ADDRESSES]\n"
...
main(int argc, char **argv)
{
    ...
    while ((ch = getopt(argc, argv, "D:fHLMx:")) != EOF)
        ...
        case 'H':
            ...
            init_agent("ifTable");      /* register our .conf handlers */
            init_ifTable();
            init_snmp("ifTable");
    ...
    /*
     * init ifTable mib code 
     */
    init_ifTable();

    /*
     * read ifTable.conf files. 
     */
    init_snmp("ifTable");
