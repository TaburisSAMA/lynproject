...
{
    printf
        ("usage: mytestTable [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING ADDRESSES]\n"
...
main(int argc, char **argv)
{
    ...
    while ((ch = getopt(argc, argv, "D:fHLMx:")) != EOF)
        ...
        case 'H':
            ...
            init_agent("mytestTable");  /* register our .conf handlers */
            init_mytestTable();
            init_snmp("mytestTable");
     ...
     */
    init_agent("mytestTable");

    /*
     * init mytestTable mib code 
     */
    init_mytestTable();

    /*
     * read mytestTable.conf files. 
     */
    init_snmp("mytestTable");
